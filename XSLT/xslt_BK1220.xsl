<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="p[@class='citation-liste-tiret-item']">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
    ...
    <xsl:template match="li[@class='encadre-liste-puce-item']">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
            <span class="body-justify">
                <xsl:apply-templates/>
    ...
    <xsl:template match="li[@class='retenir-liste-puce-item']">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
            <span class="body-justify">
                <xsl:apply-templates/>
    ...
    <xsl:template match="li[@class='encadre-liste-num-item']">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
            <span class="body-justify">
                <xsl:apply-templates/>
